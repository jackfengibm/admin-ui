...
OrganizationsTab.prototype.showDetails = function(table, organization, row)
{
    ...
    $(spacesLink).html(Format.formatNumber(row[4]));
    ...
    $(developersLink).html(Format.formatNumber(row[5]));
    ...
    this.addPropertyRow(table, "Quota", Format.formatString(row[6]));

    var routesLink = document.createElement("a");
    $(routesLink).attr("href", "");
    $(routesLink).addClass("tableLink");
    $(routesLink).html(Format.formatNumber(row[7]));
    ...
    this.addPropertyRow(table, "Used Routes", Format.formatNumber(row[8]));
    this.addPropertyRow(table, "Unused Routes", Format.formatNumber(row[9]));

    var instancesLink = document.createElement("a");
    $(instancesLink).attr("href", "");
    $(instancesLink).addClass("tableLink");
    $(instancesLink).html(Format.formatNumber(row[10]));
    ...
    $(servicesLink).html(Format.formatNumber(row[11]));
    ...
    $(appsLink).html(Format.formatNumber(row[17]));
    ...
    this.addPropertyRow(table, "Started Apps",    Format.formatNumber(row[18]));
    this.addPropertyRow(table, "Stopped Apps",    Format.formatNumber(row[19]));
    this.addPropertyRow(table, "Pending Apps",    Format.formatNumber(row[20]));
    this.addPropertyRow(table, "Staged Apps",     Format.formatNumber(row[21]));
    this.addPropertyRow(table, "Failed Apps",     Format.formatNumber(row[22]));
}
