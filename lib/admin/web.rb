...
module AdminUI
  class Web < Sinatra::Base
    ...
    get '/applications', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/applications'
    ...
    get '/cloud_controllers', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/cloud_controllers'
    ...
    get '/components', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/components'
    ...
    get '/deas', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/deas'
      @varz.deas.to_json
    end
    ...
    get '/gateways', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/gateways'
    ...
    get '/health_managers', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/health_managers'
    ...
    get '/logs', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/logs'
    ...
    get '/organizations', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/organizations'
      @cc.organizations.to_json
    end

    get '/quota_definitions', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/quota_definitions'
    ...
    get '/routers', :auth => [:user] do
      @logger.info_user session[:username],  'get', '/routers'
      @varz.routers.to_json
    end

    get '/routes', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/routes'
      @cc.routes.to_json
    end
    ...
    get '/services', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/services'
      @cc.services.to_json
    end

    get '/service_bindings', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/service_bindings'
      @cc.service_bindings.to_json
    end

    get '/service_brokers', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/service_brokers'
    ...
    get '/service_instances', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/service_instances'
    ...
    get '/service_plans', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/service_plans'
    ...
    get '/spaces_auditors', :auth => [:user] do
      @logger.info_user session[:username],  'get', '/spaces_auditors'
      @cc.spaces_auditors.to_json
    end

    get '/spaces_developers', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/spaces_developers'
      @cc.spaces_developers.to_json
    end

    get '/spaces_managers', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/spaces_managers'
    ...
    get '/tasks', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/tasks'
    ...
    get '/users', :auth => [:user] do
      @logger.info_user session[:username], 'get', '/users'
      @cc.users.to_json
    end
